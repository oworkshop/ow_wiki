...
(function (OWWordDEVerb) {
    ...
    function newButton(text, Kapitel) {
        ...
        button.setAttribute("onclick", "OWWordDEVerb.nextTest(\"".concat(Kapitel, "\")"));
    ...
    OWWordDEVerb.hiddenAnswer = hiddenAnswer;
    function showAnswer() {
        // @ts-ignore
        $("#modal1-answer").css("visibility", "visible");
    }
    OWWordDEVerb.showAnswer = showAnswer;
    function nextTest(Kapitel) {
        var _a, _b, _c;
        hiddenAnswer();
        // @ts-ignore
        $("#modal1-show").attr("onclick", "OWWordDEVerb.showAnswer()");
        // @ts-ignore
        $("#modal1-next").attr("onclick", "OWWordDEVerb.nextTest(\"".concat(Kapitel, "\")"));
    ...
    OWWordDEVerb.nextTest = nextTest;
})(OWWordDEVerb || (OWWordDEVerb = {}));
// 使用以下命令生成gm_wort.js
// tsc ow_word_de_verb.ts --target "es5" --lib "es2015,dom" --downlevelIteration
