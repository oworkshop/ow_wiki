...
<li><a href="#org95727cb">14. 题目分析</a>
  <ul>
  <li><a href="#orgda2e8bf">14.1. 050计算</a></li>
  <li><a href="#orge4ab8ba">14.2. 050数据库</a></li>
  </ul>
  </li>
</ul>
</div>
...
func (t *TOC) HTML() string {
	if len(t.List) == 0 {
		return fmt.Sprintf(TOCTemplate, "")
	}
	...
	return fmt.Sprintf(TOCTemplate, strings.Join(tree.HTML(), "\n"))
}
